...
Need to add something here... (or maybe not?)

- or maybe i'll make the table here? maybe a demographics table here and then more specific tables for each figure?

I would normally prefer to use "climate change" over "global warming," but I was trying to be consistent with the terminology used in the survey.
...
dfc_voter %>% 
  ...
  labs(y = "Average Worry", x = "Political Leanings",
       title = "Global Warming Concern by Political Ideology and Voter Registration",
...
- Related plot for an academic audience?
- Create a table here
...
harm_plot %>% 
  ...
  labs(x = "Year", y = "Percent of Responses",
       title = "Perceived Risk Posed by Global Warming to Various Targets",
...
pol_plot %>%
  ...
  labs(y = "Percent of Responses",
       x = NULL,
       title = "Global Warming Policy Support in 2018",
...
pol_plot %>%
  ...
  labs(y = "Percent of Responses",
       ...
       title = "Global Warming Policy Support in 2018",
       subtitle = 'Question: "How much do you support or oppose..."\n\n') +
  scale_x_discrete(labels = c(expression("Regulating" ~ CO[2] ~ "as a pollutant"),
                              "Requiring electric utilities to\n produce at least 20% of electricity\n using renewable resources",
                              "Funding more research into\n renewable energy sources",
                              expression("Setting strict" ~ CO[2] ~ "emission limits on coal-fired power plants"))) +
  theme_light() +
  theme(plot.title.position = "plot",
        legend.position = c(0,1),
        legend.justification = c(.36,0),
...
pol_plot %>%
  ...
  labs(y = "Percent of Responses\n\n",
       x = NULL,
       title = "Climate Change Policy Support in 2018",
       subtitle = 'Question: "How much do you support or oppose..."') +
  scale_x_discrete(labels = c("Regulating CO^2 as a pollutant",
                              "Requiring electric utilities to\n produce at least 20% of electricity\n using renewable resources",
                              "Funding more research into\n renewable energy sources",
...
- Percent values on the bars. 
- Superscript of the policy labels. 
- Facet wrap this by political party affiliation/leaning.
- table?
