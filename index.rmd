...
pol_plot %>%
  ...
  scale_x_discrete(labels = c(expression(atop("Funding more research into", "renewable energy sources")),
                              expression("Regulating" ~ CO[2] ~ "as a pollutant"),
                              expression(atop("Requiring utilities to produce >20% of", " electricity using renewable resources")),
                              expression(atop("Setting strict"~CO[2]~"emission limits", "on coal-fired power plants")))) +
  theme_light() +
  theme(plot.title.position = "plot",
