...
I'd like to model this plot similarly to the common Pew bar plot format, wherein the bars are stacked and all centered at the divide between support/oppose instead of being left aligned at zero. Plot also needs to become more user-friendly (more meaningful labels, maybe labels of the exact percentage at the end of each bar).
...
I'd like to put the legend at the bottom of the plot and fix the dimensions so that the x axis labels don't overlap.
